...
const HeadlessDropdownBase = forwardRef(({ 
  classes, 
  ...
  return (
    <div className={dialogClasses.root}>
      <Menu>
        <Menu.Button>{_button}</Menu.Button>
        <Menu.Items className={dialogClasses.dialog}>
          {children}
        </Menu.Items>
      </Menu>
    </div>
...
HeadlessDropdownBase.propTypes = {
...
HeadlessDropdownBase.defaultProps = {
  classes: { 
    root: '',
    container: '',
    content: '',
...
HeadlessDropdownBase.displayName = 'HeadlessDropdownBase'

export default HeadlessDropdownBase
