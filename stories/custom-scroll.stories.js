...
export const Normal = () => {
  const contentClass = 'bg-primary-400 text-white text-center h-40 w-full mb-2'
  const lumenScrollStyle = customScroll('success')
  const customScrollStyle = customScroll(undefined, '10px', 'red', 'green', 'orange', 'purple')

  return (
    <Layout>
      <p className='mb-2'>Only with lumen predefined color rules</p>
      <Layout.Content className={`${contentClass} ${lumenScrollStyle}`}>
        <p>
      ...
      <p className='mb-2'>Custom width and color</p>
