  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'light-10': '0px 1px 10px rgba(12, 12, 13, 0.05)',
        'light-20': '0px 2px 20px rgba(12, 12, 13, 0.05)',
        'light-30': '0px 4px 30px rgba(12, 12, 13, 0.05)',
        'light-40': '0px 8px 40px rgba(0, 0, 0, 0.05)',
        'blue-10': '0 1px 4px 0 rgba(0, 117, 255, 0.1)',
        'blue-20': '0px 2px 8px rgba(0, 117, 255, 0.15)',
        'blue-30': '0 4px 12px 0 rgba(0, 117, 255, 0.2)',
        'blue-40': '0px 8px 16px rgba(0, 117, 255, 0.25)',
      },
